...
int		main(void)
{
	//char str[] = "bonjour la street";
	//printf("%0*d", 15, 10);

	//flag '.' fait comme le flag '*' mais le nb de truc a mettre est specifié dans la string, il faut call un atoi pour savoir cb
	//falg '*' sert a mettre des espaces, il faut rajouter un arguement qui dit le nb d'espace que tu veux bg, et apres ce que tu veux
	//flag '-' sert a mettre a gauche la largeur de champ, test avec printf("%-*d", 4, 1); bg
	//flag '0' fonctionne que avec les nbr, doit etre use avec . ou *
	//mettre la fonction putstr a la fin et la traiter independament des autres
//!"#
	printf("%d\n", printf("%-03.7%"));
	//while (1)
	//printf("%d", printf("%123.15s\n", NULL));
	//printf("%u\n", -1);
	//printf("%-2.c\n", 'r');
	//ft_printf("%c\n%s\n%p\n%d\n%i\n%u\n%x\n%X\n%%\n", '\200', NULL, str, -2147483647, 200, -10, -411, -411);
	//ft_printf("\n");
	//printf("%c\n%s\n%p\n%d\n%i\n%u\n%x\n%X\n%%\n", '\200', NULL, str, -2147483647, 200, -10, -411, -411);
	return (0);
}*/
//condition cest davoir 0 de precision et davoir 0 en nbr
/* ************************************************************************** */
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   .test2.c                                           :+:      :+:    :+:   */
...
/*   Updated: 2019/11/13 15:55:48 by jgrandne         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(){
	...
	printf("{%d}\n", printf("\033[1;32mTest 14 => \033[0m|%*.*d|", 0, 5, 0));
	ft_printf("{%d}\n", ft_printf("\033[1;31mTest 14 => \033[0m|%*.*d|", 0, 5, 0));
